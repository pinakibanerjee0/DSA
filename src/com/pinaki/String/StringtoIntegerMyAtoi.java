...
public class StringtoIntegerMyAtoi {
	 ...
	 * next the characters until the next non-digit character or the end of the
	 * input is reached. The rest of the string is ignored. Convert these digits
	 ...
	 * 
	 * Input: s = "   -42" Output: -42 Explanation: Step 1: "   -42" (leading
	 * whitespace is read and ignored) ^ Step 2: "   -42" ('-' is read, so the
	 * result should be negative) ^ Step 3: "   -42" ("42" is read in) ^ The parsed
	 * integer is -42. Since -42 is in the range [-231, 231 - 1], the final result
	 * is -42. Example 3:
	 * 
	 * Input: s = "4193 with words" Output: 4193 Explanation: Step 1:
	 ...
	 * '-' nor '+') ^ Step 3: "4193 with words" ("4193" is read in; reading stops
	 * because the next character is a non-digit) ^ The parsed integer is 4193.
	...
	//	String s = "   4193 with words";
		System.out.println("Plese enter the Input String");
		Scanner sc=new Scanner(System.in);  
		String s = sc.nextLine();
		System.out.println("The Int Value of the given String is :"+myAtoi(s));
	}
}
